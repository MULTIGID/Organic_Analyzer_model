...
TEXT = {
    "EN": {
        ...
        "bioscan_task": "Recognizes 11,846 insect species from the labeled image subset of BIOSCAN-5M.",
    ...
    "УКР": {
        ...
        "bioscan_task": "Розпізнає 11 846 видів комах за розміченою частиною зображень BIOSCAN-5M.",
